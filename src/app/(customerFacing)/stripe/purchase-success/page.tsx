    ...
    return (
        ...
        <div className="flex gap-4 items-center">
            ...
            <div>
                ...
                <Button className="mt-4" size="lg" asChild>{isSuccess ? <a href={`/products/download/${await createDownloadVerification(product.id)}`}>Download</a> : <Link href={`/products/${product.id}/purchase`}>Try Again</Link>}
                </Button>
            </div>
        </div>
    </div>
